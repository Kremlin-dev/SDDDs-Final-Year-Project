...
# Initialize I2C
i2c = I2C(2)  # Use I2C bus 2, which is typically used on OpenMV Cam

# Initialize the LSM6DSOX IMU
lsm = lsm6dsox.LSM6DSOX(i2c)

# Data rate values for testing
data_rate_values = (
...
# Set initial data rate for accelerometer
lsm.acceleration_data_rate = lsm6dsox.RATE_104_HZ

while True:
    for acceleration_data_rate in data_rate_values:
        print("Current Acceleration data rate setting: ", acceleration_data_rate)
...
## Initialize I2C (assuming the correct I2C bus for the built-in sensor)
#i2c = I2C(2)  # Use I2C bus 2, which is typically used on OpenMV Cam
...
#imu.configure_accelerometer(scale=0x00, rate=0x80)
